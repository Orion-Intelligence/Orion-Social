...
class ThreatType(str, Enum):
    ...
    NEWS = "news_collector"
    BLOGGER = "blogger_collector"
    BLUESKY = "bluesky_collector"
    DEVTO = "devto_collector"
    ...
    HABR = "habr_collector"
    HACKERNOON = "hackernoon_collector"
    HASHNODE = "hashnode_collector"
    TRACKING = "tracking_collector"
    PASTEBIN = "pastebin_collector"
    MASTODON = "mastodon_collector"
    MEDIUM = "medium_collector"
    MICROBLOG = "microblog_collector"
    MISSKEY = "misskey_collector"
    NOSTR = "nostr_collector"
    PLEROMA = "pleroma_collector"
    PRIMAL = "primal_collector"
    QUORA = "quora_collector"
    STACKOVERFLOW = "stackoverflow_collector"
    SUBSTACK = "substack_collector"
    THREADS = "threads_collector"
