...
class RuleModel:
    def __init__(self, m_timeout: int = 47200, m_fetch_config: FetchConfig = FetchConfig.PLAYRIGHT, m_fetch_proxy: FetchProxy = FetchProxy.NONE, m_javascript = True, m_resoource_block = True, m_threat_type=None):
