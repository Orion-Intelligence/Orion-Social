...
class celery_shared_data:
    ...
    def get_network_status(self):
        return self.redis_controller_instance.invoke_trigger(REDIS_COMMANDS.S_GET_BOOL,
                                                             [REDIS_KEYS.S_NETWORK_MONITOR_STATUS, False, None])

    def set_network_status(self, p_status):
        self.redis_controller_instance.invoke_trigger(REDIS_COMMANDS.S_SET_BOOL,
                                                      [REDIS_KEYS.S_NETWORK_MONITOR_STATUS, p_status, None])
