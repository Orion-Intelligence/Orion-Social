...
class helper_method:
    ...
    def extract_refhtml(url: str, invoke_db, REDIS_COMMANDS, CUSTOM_SCRIPT_REDIS_KEYS, RAW_PATH_CONSTANTS, page) -> str | None:
        ...
        if not url.startswith("http"):
            url = f"https://{url.removeprefix('http://').removeprefix('https://')}"
    ...
    def get_screenshot_base64(page, search_string, base_url):
        empty_screenshot = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+yv1cAAAAASUVORK5CYII="
        try:
