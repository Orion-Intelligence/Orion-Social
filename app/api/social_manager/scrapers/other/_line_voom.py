...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "LINE VOOM",
    "profile_url": "https://linevoom.line.me/user/{username}",
    "domains": [
        "linevoom.line.me"
    ]
}
...
class _line_voom(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "line_voom"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "line_voom"
