...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Tencent Video",
    "profile_url": "https://v.qq.com/x/cover/{username}.html",
    "domains": [
        "v.qq.com"
    ]
}
...
class _tencent_video(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "tencent_video"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "tencent_video"
