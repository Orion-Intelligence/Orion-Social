...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "profile_url": "https://archive.org/details/@{username}",
    "domains": [
        "archive.org"
    ]
}
...
class _archive_org(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "archive_org"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "archive_org"
