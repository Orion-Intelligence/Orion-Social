...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "page_url": "https://steamcommunity.com/id/{username}",
    "group_url": "https://steamcommunity.com/groups/{username}",
}


class _steam_community(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "steam_community"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "steam_community"
