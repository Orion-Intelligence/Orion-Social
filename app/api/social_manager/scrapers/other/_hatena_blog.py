...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Hatena Blog",
    "profile_url": "https://{username}.hatenablog.com/",
    "domains": [
        "hatenablog.com"
    ],
    "subdomain": True,
    "page_url": "https://{username}.hatenablog.com/",
}


class _hatena_blog(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "hatena_blog"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "hatena_blog"
