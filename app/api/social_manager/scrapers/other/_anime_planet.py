...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Anime-Planet",
    "profile_url": "https://www.anime-planet.com/users/{username}",
    "domains": [
        "anime-planet.com"
    ]
}
...
class _anime_planet(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "anime_planet"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "anime_planet"
