...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "profile_url": "https://github.com/sponsors/{username}",
    "domains": [
        "github.com"
    ],
    "page_url": "https://github.com/sponsors/{username}",
}


class _github_sponsors(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "github_sponsors"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "github_sponsors"
