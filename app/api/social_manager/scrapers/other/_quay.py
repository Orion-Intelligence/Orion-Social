...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Quay",
    "profile_url": "https://quay.io/user/{username}",
    "domains": [
        "quay.io"
    ],
    "page_url": "https://quay.io/organization/{username}",
}


class _quay(extraction_interface, ABC):
    _instance = None
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "quay"
