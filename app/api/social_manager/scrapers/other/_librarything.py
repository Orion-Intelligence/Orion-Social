...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "LibraryThing",
    "profile_url": "https://www.librarything.com/profile/{username}",
    "domains": [
        "librarything.com"
    ]
}
...
class _librarything(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "librarything"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "librarything"
