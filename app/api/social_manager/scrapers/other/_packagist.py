...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Packagist",
    "profile_url": "https://packagist.org/users/{username}/",
    "domains": [
        "packagist.org"
    ]
}
...
class _packagist(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "packagist"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "packagist"
