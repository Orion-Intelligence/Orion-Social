...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Naver Blog",
    "profile_url": "https://blog.naver.com/{username}",
    "domains": [
        "blog.naver.com"
    ],
    "page_url": "https://blog.naver.com/{username}",
}


class _naver_blog(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "naver_blog"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "naver_blog"
