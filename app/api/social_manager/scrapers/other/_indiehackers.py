...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Indie Hackers",
    "profile_url": "https://www.indiehackers.com/{username}",
    "domains": [
        "indiehackers.com"
    ]
}
...
class _indiehackers(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "indiehackers"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "indiehackers"
