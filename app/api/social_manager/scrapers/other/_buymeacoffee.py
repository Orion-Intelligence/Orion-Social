...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "page_url": "https://www.buymeacoffee.com/{username}",
}


class _buymeacoffee(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "buymeacoffee"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "buymeacoffee"
