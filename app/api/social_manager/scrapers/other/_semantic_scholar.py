...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "profile_url": "https://www.semanticscholar.org/author/{username}",
    "domains": [
        "semanticscholar.org"
    ]
}
...
class _semantic_scholar(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "semantic_scholar"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "semantic_scholar"
