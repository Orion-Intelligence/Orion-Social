...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "page_url": "https://vimeo.com/channels/{username}",
    "group_url": "https://vimeo.com/groups/{username}",
}


class _vimeo(extraction_interface, ABC):
    _instance = None
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "vimeo"
