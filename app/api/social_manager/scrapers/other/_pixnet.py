...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "PIXNET",
    "profile_url": "https://{username}.pixnet.net/blog",
    "domains": [
        "pixnet.net"
    ],
    "subdomain": True,
    "page_url": "https://{username}.pixnet.net/blog",
}


class _pixnet(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "pixnet"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "pixnet"
