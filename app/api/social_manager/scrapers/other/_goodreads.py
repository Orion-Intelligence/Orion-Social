...
PLATFORM_CONFIG: Dict[str, Any] = {
    ...
    "group_url": "https://www.goodreads.com/group/show/{username}",
}


class _goodreads(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "goodreads"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "goodreads"
