...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "Liberapay",
    "profile_url": "https://liberapay.com/{username}/",
    "domains": [
        "liberapay.com"
    ],
    "page_url": "https://liberapay.com/{username}/",
}


class _liberapay(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "liberapay"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "liberapay"
