...
PLATFORM_CONFIG: Dict[str, Any] = {
    "name": "LiveJournal",
    "profile_url": "https://{username}.livejournal.com/",
    "domains": [
        "livejournal.com"
    ],
    "subdomain": True
...
class _livejournal(extraction_interface, ABC):
    _instance = None

    def __init__(self, callback=None):
        super().__init__()
        self.callback = callback
        self.platform = "livejournal"
        self._card_data = []
        self._entity_data = []
        self.soup = None
        self.m_seed_url = ""
    ...
    def supports(cls, platform: str) -> bool:
        return (platform or "").strip().lower() == "livejournal"
