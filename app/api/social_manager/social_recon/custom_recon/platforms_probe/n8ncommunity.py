...
from api.social_manager.social_recon.constants.platform_constants import N8nCommunityConstants

constants = N8nCommunityConstants


def probe_url(username: str) -> str:
    return N8nCommunityConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(N8nCommunityConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(N8nCommunityConstants, "AVATAR_KEYS", ()), getattr(N8nCommunityConstants, "COVER_KEYS", ()))
