...
def probe_url(username: str) -> str:
    return INaturalistConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(INaturalistConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(INaturalistConstants, "AVATAR_KEYS", ()), getattr(INaturalistConstants, "COVER_KEYS", ()))
