...
def probe_url(username: str) -> str:
    return ErogenClubConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(ErogenClubConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(ErogenClubConstants, "AVATAR_KEYS", ()), getattr(ErogenClubConstants, "COVER_KEYS", ()))
