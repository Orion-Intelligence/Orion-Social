...
from api.social_manager.social_recon.constants.platform_constants import Oglaszamy24hConstants

constants = Oglaszamy24hConstants


def probe_url(username: str) -> str:
    return Oglaszamy24hConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(Oglaszamy24hConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(Oglaszamy24hConstants, "AVATAR_KEYS", ()), getattr(Oglaszamy24hConstants, "COVER_KEYS", ()))
