...
def probe_url(username: str) -> str:
    return N23hqConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(N23hqConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(N23hqConstants, "AVATAR_KEYS", ()), getattr(N23hqConstants, "COVER_KEYS", ()))
