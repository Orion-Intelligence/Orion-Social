...
def evaluate(status: int, body: str, _final_url: str) -> tuple[str, dict]:
    ...
    info = {
        ...
        "description": parse.clean(payload.get("about")),
        "created_at": parse.text(payload.get("created")),
        "karma": parse.text(payload.get("karma")) if payload.get("karma") else "",
        "submissions": parse.text(len(submitted)) if isinstance(submitted, list) else "",
    }
