...
def evaluate(status: int, body: str, _final_url: str) -> tuple[str, dict]:
    ...
    if re.search(FacebookConstants.PAGE_PATTERN, description, flags=re.IGNORECASE):
        info["target_type"] = "page"
    for key, pattern in (("likes", FacebookConstants.LIKES), ("followers", FacebookConstants.FOLLOWERS), ("talking_about", FacebookConstants.TALKING)):
