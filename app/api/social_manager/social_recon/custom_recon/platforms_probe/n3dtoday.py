...
from api.social_manager.social_recon.constants.platform_constants import N3dtodayConstants

constants = N3dtodayConstants


def probe_url(username: str) -> str:
    return N3dtodayConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(N3dtodayConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(N3dtodayConstants, "AVATAR_KEYS", ()), getattr(N3dtodayConstants, "COVER_KEYS", ()))
