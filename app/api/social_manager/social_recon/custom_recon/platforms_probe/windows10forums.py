...
def probe_url(username: str) -> str:
    return Windows10forumsConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(Windows10forumsConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(Windows10forumsConstants, "AVATAR_KEYS", ()), getattr(Windows10forumsConstants, "COVER_KEYS", ()))
