...
def probe_url(username: str) -> str:
    return E621Constants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(E621Constants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(E621Constants, "AVATAR_KEYS", ()), getattr(E621Constants, "COVER_KEYS", ()))
