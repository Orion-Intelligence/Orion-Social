...
from api.social_manager.social_recon.constants.platform_constants import ZhihuConstants

constants = ZhihuConstants


def probe_url(username: str) -> str:
    return ZhihuConstants.PROFILE_URL.format(username=username)
