...
from api.social_manager.social_recon.constants.platform_constants import BadooConstants

constants = BadooConstants


def probe_url(username: str) -> str:
    return BadooConstants.PROFILE_URL.format(username=username)
