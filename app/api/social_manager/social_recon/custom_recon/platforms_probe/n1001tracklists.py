...
def probe_url(username: str) -> str:
    return N1001tracklistsConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(N1001tracklistsConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(N1001tracklistsConstants, "AVATAR_KEYS", ()), getattr(N1001tracklistsConstants, "COVER_KEYS", ()))
