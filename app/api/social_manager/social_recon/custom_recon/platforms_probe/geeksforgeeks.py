...
def probe_url(username: str) -> str:
    return GeeksforGeeksConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(GeeksforGeeksConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(GeeksforGeeksConstants, "AVATAR_KEYS", ()), getattr(GeeksforGeeksConstants, "COVER_KEYS", ()))
