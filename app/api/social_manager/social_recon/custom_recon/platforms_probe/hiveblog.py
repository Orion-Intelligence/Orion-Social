...
def probe_url(username: str) -> str:
    return HiveBlogConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(HiveBlogConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(HiveBlogConstants, "AVATAR_KEYS", ()), getattr(HiveBlogConstants, "COVER_KEYS", ()))
