...
from api.social_manager.social_recon.constants.platform_constants import BrighteonSocialConstants

constants = BrighteonSocialConstants


def probe_url(username: str) -> str:
    return BrighteonSocialConstants.PROFILE_URL.format(username=username)


def fetch(username: str) -> tuple[int, str, str]:
    return http_client.fetch(BrighteonSocialConstants.API_URL.format(username=username))
