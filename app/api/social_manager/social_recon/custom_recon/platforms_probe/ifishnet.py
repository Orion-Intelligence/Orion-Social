...
def probe_url(username: str) -> str:
    return IfishNetConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(IfishNetConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(IfishNetConstants, "AVATAR_KEYS", ()), getattr(IfishNetConstants, "COVER_KEYS", ()))
