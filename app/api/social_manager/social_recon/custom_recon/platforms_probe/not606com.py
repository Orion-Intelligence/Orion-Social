...
def probe_url(username: str) -> str:
    return Not606ComConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(Not606ComConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(Not606ComConstants, "AVATAR_KEYS", ()), getattr(Not606ComConstants, "COVER_KEYS", ()))
