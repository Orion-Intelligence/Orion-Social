...
from api.social_manager.social_recon.constants.platform_constants import ChaosfursSocialConstants

constants = ChaosfursSocialConstants


def probe_url(username: str) -> str:
    return ChaosfursSocialConstants.PROFILE_URL.format(username=username)


def fetch(username: str) -> tuple[int, str, str]:
    return http_client.fetch(ChaosfursSocialConstants.API_URL.format(username=username))
