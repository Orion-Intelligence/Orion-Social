...
from api.social_manager.social_recon.constants.platform_constants import School2dobrinkaRuConstants

constants = School2dobrinkaRuConstants


def probe_url(username: str) -> str:
    return School2dobrinkaRuConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(School2dobrinkaRuConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(School2dobrinkaRuConstants, "AVATAR_KEYS", ()), getattr(School2dobrinkaRuConstants, "COVER_KEYS", ()))
