...
def probe_url(username: str) -> str:
    return N4gameforumConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(N4gameforumConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(N4gameforumConstants, "AVATAR_KEYS", ()), getattr(N4gameforumConstants, "COVER_KEYS", ()))
