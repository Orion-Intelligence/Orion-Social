...
def probe_url(username: str) -> str:
    return ElixirforumConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(ElixirforumConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(ElixirforumConstants, "AVATAR_KEYS", ()), getattr(ElixirforumConstants, "COVER_KEYS", ()))
