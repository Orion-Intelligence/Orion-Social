...
def probe_url(username: str) -> str:
    return TheOdysseyOnlineConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(TheOdysseyOnlineConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(TheOdysseyOnlineConstants, "AVATAR_KEYS", ()), getattr(TheOdysseyOnlineConstants, "COVER_KEYS", ()))
