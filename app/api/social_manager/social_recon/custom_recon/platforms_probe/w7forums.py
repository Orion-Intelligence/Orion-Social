...
def probe_url(username: str) -> str:
    return W7forumsConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(W7forumsConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(W7forumsConstants, "AVATAR_KEYS", ()), getattr(W7forumsConstants, "COVER_KEYS", ()))
