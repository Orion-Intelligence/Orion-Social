...
def probe_url(username: str) -> str:
    return XtratimeOrgConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(XtratimeOrgConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(XtratimeOrgConstants, "AVATAR_KEYS", ()), getattr(XtratimeOrgConstants, "COVER_KEYS", ()))
