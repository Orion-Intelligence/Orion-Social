...
def probe_url(username: str) -> str:
    return LadaVestaNetConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(LadaVestaNetConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(LadaVestaNetConstants, "AVATAR_KEYS", ()), getattr(LadaVestaNetConstants, "COVER_KEYS", ()))
