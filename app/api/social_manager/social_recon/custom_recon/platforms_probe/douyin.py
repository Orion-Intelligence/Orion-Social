...
from api.social_manager.social_recon.constants.platform_constants import DouyinConstants

constants = DouyinConstants


def probe_url(username: str) -> str:
    return DouyinConstants.PROFILE_URL.format(username=username)
