...
from api.social_manager.social_recon.constants.platform_constants import CImConstants

constants = CImConstants


def probe_url(username: str) -> str:
    return CImConstants.PROFILE_URL.format(username=username)


def fetch(username: str) -> tuple[int, str, str]:
    return http_client.fetch(CImConstants.API_URL.format(username=username))
