...
def probe_url(username: str) -> str:
    return HitmanforumConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(HitmanforumConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(HitmanforumConstants, "AVATAR_KEYS", ()), getattr(HitmanforumConstants, "COVER_KEYS", ()))
