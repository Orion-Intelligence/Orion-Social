...
from api.social_manager.social_recon.constants.platform_constants import Tfw2005ComConstants

constants = Tfw2005ComConstants


def probe_url(username: str) -> str:
    return Tfw2005ComConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(Tfw2005ComConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(Tfw2005ComConstants, "AVATAR_KEYS", ()), getattr(Tfw2005ComConstants, "COVER_KEYS", ()))
