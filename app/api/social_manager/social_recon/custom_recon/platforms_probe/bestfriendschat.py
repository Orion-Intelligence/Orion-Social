...
from api.social_manager.social_recon.constants.platform_constants import BestFriendsChatConstants

constants = BestFriendsChatConstants


def probe_url(username: str) -> str:
    return BestFriendsChatConstants.PROFILE_URL.format(username=username)


def fetch(username: str) -> tuple[int, str, str]:
    return http_client.fetch(BestFriendsChatConstants.API_URL.format(username=username))
