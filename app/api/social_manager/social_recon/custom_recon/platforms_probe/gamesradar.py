...
def probe_url(username: str) -> str:
    return GamesRadarConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(GamesRadarConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(GamesRadarConstants, "AVATAR_KEYS", ()), getattr(GamesRadarConstants, "COVER_KEYS", ()))
