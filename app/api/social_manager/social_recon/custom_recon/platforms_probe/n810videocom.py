...
from api.social_manager.social_recon.constants.platform_constants import N810videoComConstants

constants = N810videoComConstants


def probe_url(username: str) -> str:
    return N810videoComConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(N810videoComConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(N810videoComConstants, "AVATAR_KEYS", ()), getattr(N810videoComConstants, "COVER_KEYS", ()))
