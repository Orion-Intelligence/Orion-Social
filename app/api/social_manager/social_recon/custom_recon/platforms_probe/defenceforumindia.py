...
def probe_url(username: str) -> str:
    return DefenceForumIndiaConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(DefenceForumIndiaConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(DefenceForumIndiaConstants, "AVATAR_KEYS", ()), getattr(DefenceForumIndiaConstants, "COVER_KEYS", ()))
