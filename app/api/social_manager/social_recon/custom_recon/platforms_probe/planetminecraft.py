...
def probe_url(username: str) -> str:
    return PlanetMinecraftConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(PlanetMinecraftConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(PlanetMinecraftConstants, "AVATAR_KEYS", ()), getattr(PlanetMinecraftConstants, "COVER_KEYS", ()))
