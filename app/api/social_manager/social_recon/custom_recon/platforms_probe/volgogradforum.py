...
def probe_url(username: str) -> str:
    return VolgogradForumConstants.PROFILE_URL.format(username=username)
...
def evaluate(status: int, body: str, final_url: str) -> tuple[str, dict]:
    ...
    if not heading or heading.casefold() in getattr(VolgogradForumConstants, "GENERIC", set()):
        return VerdictConstants.UNKNOWN, {}
    info = parse.social_info(body, getattr(VolgogradForumConstants, "AVATAR_KEYS", ()), getattr(VolgogradForumConstants, "COVER_KEYS", ()))
