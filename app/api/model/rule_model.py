...
class RuleModel:
    def __init__(self, m_timeout: int = 17200, m_fetch_config: FetchConfig = FetchConfig.SELENIUM,
                 m_fetch_proxy: FetchProxy = FetchProxy.NONE, m_resoource_block=True, m_threat_type=ThreatType.LEAK):
